...
struct server_prompt_cache {
    ...
    // replaced (optional): set to true if the slot's prompt was swapped for a cache entry
    bool load(server_prompt & prompt, const server_tokens & tokens_new, llama_context * ctx_tgt, llama_context * ctx_dft, int32_t id_slot, bool * replaced = nullptr);
